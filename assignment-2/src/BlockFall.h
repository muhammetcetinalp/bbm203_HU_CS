...
public:
    ...
    static vector<vector<bool>>right_rotate(const std::vector<vector<bool>>& original_shape);
    static vector<vector<bool>>left_rotate(const std::vector<vector<bool>>& original_shape);
};
